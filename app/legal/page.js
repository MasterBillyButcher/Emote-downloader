  ...
  return (
    <main className="page legal-page">
      ...
      <section id="terms">
        ...
        <h3>What this is</h3>
        <p>
          Emote Grabber fetches emote images from 7TV, BetterTTV, FrankerFaceZ, and Twitch&apos;s
          own API based on a channel name you provide, and packages them into a zip file for
          download.
        </p>
        ...
        <p>
          ...
          sponsored by Twitch Interactive, Inc., 7TV, BetterTTV, or FrankerFaceZ. Product names,
          logos, and brands referenced belong to their respective owners and are used only to
          describe which services this tool is compatible with.
        </p>

        <h3>Ownership of emote content</h3>
        <p>
          Emote artwork remains the property of its original creator and/or the platform hosting
          it. Using this Service does not grant any license, ownership, or right to redistribute,
          sell, or commercially use downloaded emotes beyond what the original platform and
          creator already permit. You are responsible for ensuring your own use of anything you
          download complies with the terms of the platform it came from and with applicable
          copyright law.
        </p>
        ...
        <p>
          ...
          of any kind. Third-party APIs it depends on can change, rate-limit, or go offline
          without notice, which may cause downloads to fail or return incomplete results.
        </p>
        ...
        <p>
          ...
          data, lost access to third-party accounts, or disputes over downloaded content.
        </p>

        <h3>Changes</h3>
        <p>These Terms may be updated from time to time. Continued use of the Service after a change means you accept the update.</p>
      </section>
      ...
      <section id="privacy">
        ...
        <p>
          The channel name/URL you enter and the options you pick (sources, format, tier, access
          code if one is set) are sent to a server-side function to fulfill that request. The
          Service has no database and does not persist this information after the request
          completes.
        </p>

        <h3>No accounts, no cookies</h3>
        <p>The Service does not require an account, does not use tracking cookies, and does not run third-party analytics or advertising scripts.</p>
        ...
        <p>
          ...
          policies govern how they handle data related to those requests on their end.
        </p>

        <h3>Hosting-level logging</h3>
        <p>
          This Service runs on standard cloud hosting infrastructure, which may collect
          infrastructure-level logs (such as IP addresses) for security and abuse prevention,
          independent of anything the Service itself does.
        </p>
      ...
      <section id="copyright">
        ...
        <p>
          ...
          persists on the Service&apos;s infrastructure after your download completes.
        </p>

        <h3>Ownership</h3>
        <p>
          All emote artwork is the property of its original creator and/or the platform hosting
          it. This Service does not claim ownership over emote content and does not grant any
