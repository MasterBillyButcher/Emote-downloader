...
export const SOURCE_INFO = [
  ...
  },
  {
    ...
    body: "The only source here that's native to Twitch itself, visible to every viewer with no extension needed, unlocked by subscription tier.",
  },
];
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Yes, it's a normal web page with no install. Works in any modern mobile browser.",
  },
  {
