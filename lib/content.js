...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Usually, but not guaranteed. It's a different Twitch API endpoint than the emote ones, and Twitch has at times restricted it to a broadcaster's own login rather than an app-level credential like this tool uses. If it fails on a given deployment, that source will show a clear error instead of breaking the rest of the download. Cheer Badges uses this same endpoint and carries the same caveat.",
  },
  {
    q: "What are Cheermotes, and why do I get so many of them?",
    a: "Cheermotes are the animated icons (like Cheer100 or Cheer1000) chat shows when someone cheers Bits. With \"include global emotes\" off, you only get a channel's own custom Cheermote tier set (if it has one). Turn that on and you'll also get Twitch's default Cheer/PogChamp-style tier set, which is identical across every channel — that's the bulk of the count.",
  },
];
